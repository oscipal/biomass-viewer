...
from .routes import assets, coverage, decompose, download, geocode, meta, search, stitch, tiles
...
for module in (meta, search, tiles, download, decompose, stitch, coverage, assets, geocode):
